...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("sainttools.com", "dnsseed.sainttools.com"));
        vSeeds.push_back(CDNSSeedData("saintpool.org", "dnsseed.saintpool.org"));
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.saint.loshan.co.uk"));
        ...
        // Saint: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("sainttools.com", "testnet-seed.sainttools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.saint.loshan.co.uk"));
        ...
        // Saint: v2 enforced using Bitcoin's supermajority rule
