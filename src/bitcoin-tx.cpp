...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Saint Core saint-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  saint-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded saint transaction") + "\n" +
              "  saint-tx [options] -create [commands]   " + _("Create hex-encoded saint transaction") + "\n" +
              "\n";
